      ...
      |> Enum.reduce(%{erc_1155: [], other: [], tokens: %{}, balances_map: %{}}, fn %{
        ...
        prepared_ctb = %{
          token_contract_address_hash:
            ExplorerHelper.adds_0x_prefix(stale_current_token_balance.token.contract_address_hash.bytes),
          address_hash: ExplorerHelper.adds_0x_prefix(address_hash.bytes),
