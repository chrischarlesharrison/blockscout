defmodule Indexer.Transform.TokenTransfers do
  ...
  import Explorer.Helper, only: [adds_0x_prefix: 1, decode_data: 2, truncate_address_hash: 1]
  ...
  defp parse_params(
    ...
    token_transfer = %{
      ...
      block_hash: log.block_hash,
      log_index: log.index,
      from_address_hash: adds_0x_prefix(from_address_hash),
      to_address_hash: adds_0x_prefix(to_address_hash),
      token_contract_address_hash: log.address_hash,
      token_ids: [token_id],
      transaction_hash: log.transaction_hash,
      token_type: "ERC-721"
