defmodule Explorer.Account.Notifier.Email do
  ...
  defp compose_email(notification) do
    ...
    |> add_dynamic_field("transaction_hash", ExplorerHelper.adds_0x_prefix(notification.transaction_hash.bytes))
    |> add_dynamic_field("from_address_hash", ExplorerHelper.adds_0x_prefix(notification.from_address_hash.bytes))
    |> add_dynamic_field("to_address_hash", ExplorerHelper.adds_0x_prefix(notification.to_address_hash && notification.to_address_hash.bytes))
  ...
  defp address_hash_string(%WatchlistNotification{
       ...
       do: ExplorerHelper.adds_0x_prefix(address_hash)
